 ...
 */
    ...
    public static final String[] LEVEL1_WORDS = {
	"abort", "about", "above", "abuse", "acorn", "actor", "acute", 
	"adapt", "added", "adder", "admin", "admit", "adobe", "adopt", 
	"adore", "adult", "after", "again", "agile", "aging", "alpha", 
	"amaze", "amber", "angle", "angry", "bagel", "baker", "balls", 
	"bands", "basic", "basin", "beard", "bears", "beast", "bible", 
	"bikes", "birds", "birth", "blame", "cache", "camel", "candy", 
	"carol", "carry", "catch", "cause", "debug", "debut", "decay", 
	"decks", "defer", "delay", "donut", "doubt", "eight", "eject", 
	"elbow", "elect", "enter", "entry", "equal", "fairy", "faith", 
	"fancy", "fatal", "fault", "favor", "giant", "girls", "glass", 
	"glaze", "gloss", "glove", "happy", "harry", "harsh", "haven", 
	"heart", "hello", "heros", "human", "humor", "idiot", "image", 
	"imply", "index", "intel", "irony", "itchy", "jeans", "jewel", 
	"judge", "label", "labor", "large", "laugh", "leave", "lemon", 
	"limit", "local", "logic", "magic", "major", "match", "maybe", 
	"medal", "media", "merge", "metal", "micro", "might", "misty", 
	"mocha", "model", "music", "naive", "needs", "needy", "nerdy", 
	"night", "noise", "noisy", "novel", "nurse", "oasis", "occur", 
	"ocean", "often", "olive", "onion", "opera", "orbit", "order", 
	"organ", "other", "paint", "pairs", "panda", "panel", "panic", 
	"paper", "party", "pause", "peace", "peach", "peaks", "pearl", 
	"pears", "phone", "photo", "piano", "picky", "piece", "pilot",
	"pitch", "pivot", "pixel", "pizza", "place", "plain", "plane", 
	"point", "power", "press", "price", "print", "prize", "probe", 
	"prone", "proof", "proud", "prove", "quart", "queen", "query", 
	"queue", "quick", "quiet", "quilt", "quite", "quota", "quote", 
    "rainy", "raise", "range", "ranks", "rapid", "reach", "react", 
    "ready", "realm", "rebel", "reply", "right", "risky", "river", 
	"roast", "robot", "rocky", "rough", "round", "royal", "rumor", 
    "salad", "salty", "sandy", "savor", "savvy", "scare", "scarf",
	"scars", "scary", "scene", "scent", "scope", "score", "seize", 
	"sense", "serve", "seven", "sever", "shade", "shame", "shape", 
	"share", "shark", "sharp", "shave", "sheep", "sheet", "shelf", 
	"shell", "shirt", "shock", "short", "sixty", "skate", "skirt", 
	"skits", "skive", "slave", "sleep", "steak", "steal", "table", 
	"tardy", "taste", "tasty", "teach", "teams", "tears", "tease", 
	"teeth", "tense", "thank", "their", "theme", "there", "these", 
	"thing", "think", "third", "those", "three", "throw", "tired", 
	"tires", "title", "toast", "today", "tooth", "topic", "torch", 
	"total", "touch", "tough", "tower", "track", "trade", "train", 
	"trend", "uncle", "under", "unify", "union", "unite", "until", 
	"upper", "upset", "usual", "vague", "value", "video", "virus", 
	"visit", "vital", "vomit", "wagon", "waste", "watch", "water", 
	"whale", "where", "which", "while", "whine", "white", "whole", 
	"whose", "width", "windy", "woman", "women", "world", "worms", 
	"worry", "worse", "worst", "worth", "would", "wound", "write", 
	"wrong", "wrote", "yacht", "yarns", "yearn", "years", "yeast", 
	"yield", "yucky", "yummy", "zebra", "zones" 
	};
